 ...
 * @throws {Error} - Si ocurre algún error al buscar o actualizar la orden de compra
*/
async function updateOrderDeliveryStatusById(orderId, newStatus) {
    try {
 ...
 * @returns {Promise<Object>} - El objeto de tipo Order actualizado
 */
async function updateOrderPaymentStatusById(orderId, newStatus) {
    try {
 ...
 */
const getListProducts = async (orderId) => {
    try {
 ...
 */
const addListProducts = async (orderId, returnData) => {
    try {
 ...
 */
const updateListProducts = async (orderId, productId, updateData) => {
    try {
        const result = await Order.updateOne(
        {
            _id: orderId,
 ...
 */
const deleteListProduct = async (orderId, productId) => {
    try {
        const result = await Order.updateOne(
            { _id: orderId },
